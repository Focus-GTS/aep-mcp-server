 ...
 *
 * Usage:
 *   node scripts/extract-changelog.mjs 0.6.0
 *   node scripts/extract-changelog.mjs v0.6.0     # leading v is tolerated
 *
...
// Section headings look like:  ## [0.6.0] - 2026-08-08
const headingFor = (v) =>
...
// "### Added" subsections stay inside the section.
